<?php
    ...
    Route::group(['prefix' => 'api-admin','namespace' => 'Admin','middleware' => 'check_admin_login'], function() {
        ...
        Route::post('selectDataTime','AdminStatisticalController@selectdateStatis')->name('admin.statistical.selectdateStatis');
       
        Route::post('exportDoanhThu','AdminStatisticalController@exportDoanhThu')->name('admin.statistical.exportDoanhThu');
       
           

       
        Route::post('importDay','AdminInventoryController@importDay')->name('admin.inventory.importDay');
        Route::post('importMonth','AdminInventoryController@importMonth')->name('admin.inventory.importMonth');
        Route::post('importYear','AdminInventoryController@importYear')->name('admin.inventory.importYear');
  
        Route::post('exportDay','AdminInventoryController@exportDay')->name('admin.inventory.exportDay');
        Route::post('exportMonth','AdminInventoryController@exportMonth')->name('admin.inventory.exportMonth');
        Route::post('exportYear','AdminInventoryController@exportYear')->name('admin.inventory.exportYear');
        ...
        Route::group(['prefix' => 'transaction'], function(){
            ...
            Route::post('exportTransaction','AdminTransactionController@exportTransaction')->name('admin.transaction.exportTransaction');
            Route::get('/{transactionDay}','AdminTransactionController@selectdateTransactionDay')->name('admin.transaction.selectdateTransactionDay');
            Route::post('transactionMonth','AdminTransactionController@selectdateTransactionMonth')->name('admin.transaction.selectdateTransactionMonth');
            Route::post('transactionYear','AdminTransactionController@selectdateTransactionYear')->name('admin.transaction.selectdateTransactionYear');
            Route::post('dateTransaction','AdminTransactionController@dateTransaction')->name('admin.transaction.dateTransaction');
        ...
        Route::group(['prefix' => 'inventory'], function(){
            ...
            Route::post('selectDataTimeInline','AdminInventoryController@selectDataTimeInline')->name('admin.warehousing.selectDataTimeInline');
            Route::post('selectDataTimeExport','AdminInventoryController@selectDataTimeExport')->name('admin.warehousing.selectDataTimeExport');
            Route::post('selectDataTimeImport','AdminInventoryController@selectDataTimeImport')->name('admin.warehousing.selectDataTimeImport');
            ...
            Route::post('exportInven','AdminInventoryController@exportInven')->name('admin.inventory.exportInven');
            Route::get('inven','AdminInventoryController@getInven')->name('admin.inventory.getInven');
        });
