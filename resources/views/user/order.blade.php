...
@section('content')
    <section>
        <div class="title">Chi tiết đơn hàng DH{{ $transaction->id }}</div>
        <div class="row">
            <div class="col-4">
        ...
        <div class="content">
            ...
            <div>
                <a href="{{ route('get.user.transaction') }}" class="btn btn-light"><i class="fa fa-angle-double-left"></i> Quay lại danh sách đơn hàng</a>
