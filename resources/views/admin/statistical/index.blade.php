...
@section('content')
    ...
    <div class="row">
    <form action="/api-admin/selectDataTime" method="post">
    @csrf
        <div class="col-md-2">
        ...
        <div class="col-md-2 mt-3" >
            ...
            <button type="submit" class="btn btn-primary align-self-center">Xem Thống Kê Doanh Thu</button>
            </div>
        </div>
    </form>
        <!-- <div class="col-md-2 mt-3" >
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                    @php
                        if (strlen(strstr($dt, 'ng')) > 0){
                        $tmp = explode("/", $dt);
                    @endphp
                        <span >Doanh thu tháng: {{$tmp[1]}}/{{$tmp[2]}} đến tháng  {{$tmp[4]}}/{{$tmp[5]}} </span>
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table no-margin">
                            ...
                            <tbody>
                            <?php $i = 0; ?>
                            @foreach ($revenuebyDay as $transaction)
                                <?php $i++; ?>
                                <tr>
                                    <td>{{ $i }}</td>
                                    <td>{{ $transaction->day }}</td>
                                    <td>{{ number_format($transaction->totalMoney,0,',','.') }} đ</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
